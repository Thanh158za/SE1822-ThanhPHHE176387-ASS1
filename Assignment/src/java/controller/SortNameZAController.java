 ...
 * @author ThanhPham
 */
@WebServlet(name = "SortNameZAController", urlPatterns = {"/sortza"})
public class SortNameZAController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = dao.getProductByNameDesc();
